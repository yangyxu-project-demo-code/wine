...
var OrderInfo = require('../product/MerchantOrderInfo.js');
module.exports = React.createClass({
	...
	__addItem: function (){
		Popup.dialog({
			...
			content: <UI.Form
				method="POST"
				action='/hcredwine/merchant/createOrder'
				exts={{ merchantId: this.props.merchantId }}
				style={{ margin: 25 }}
				syncSubmit={false}
				onSubmitSuccess={this.__doSuccess}
				btns={[
					{text: '提交', icon: 'fa-plus', type: 'submit', float: 'right', style: { marginRight:0 }},
