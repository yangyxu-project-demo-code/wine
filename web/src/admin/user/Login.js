			...
			case 'forget':
				return <div>
					<UI.Form
						...
						items={[
							{ title: '邮箱', placeholder: '邮箱 (注册使用邮箱)', name:'email', type:'Input', attrs: {type: 'email'}, required: true, error: '邮箱是必填项' }
						]}  />
	...
	render:function(){
		return (
			<div className="v-login admin">
				<img className="bg-img" src="./images/bg/1.jpg" />
				<div className="main">
					<div className="head">数据管理中心</div>
					<div className="form">
						{this.renderForm()}
					</div>
					<div className="foot">上海沪春互联网有限公司 @2016 - @2017</div>
				</div>
			</div>
		);
	}
